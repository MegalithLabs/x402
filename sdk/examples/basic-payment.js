...
//
// Usage:
//   PRIVATE_KEY=0x... NETWORK=base-sepolia MAX_AMOUNT=0.10 API_URL=https://api.example.com node basic-payment.js
//
...
async function main() {
  if (!PRIVATE_KEY) {
    ...
    console.error('');
    console.error('Usage:');
    console.error('  PRIVATE_KEY=0x... NETWORK=base-sepolia MAX_AMOUNT=0.10 API_URL=https://api.example.com node basic-payment.js');
    console.error('');
    console.error('Environment variables:');
    console.error('  PRIVATE_KEY  - Your wallet private key (required)');
    console.error('  NETWORK      - Network name: base, base-sepolia, bsc, bsc-testnet (default: base-sepolia)');
